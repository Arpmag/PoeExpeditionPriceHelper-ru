...
public partial class App : System.Windows.Application
{
    ...
    private const string InstanceMutexName = @"Global\PoeExpeditionPriceHelper.SingleInstance";
    ...
    protected override void OnStartup(StartupEventArgs e)
    {
        ...
        //   PoeExpeditionPriceHelper.exe --ocr-test <imagePath>
        ...
        if (e.Args.Contains("--debug"))
        {
            ...
            Console.WriteLine("[Debug] PoeExpeditionPriceHelper starting");
        }
