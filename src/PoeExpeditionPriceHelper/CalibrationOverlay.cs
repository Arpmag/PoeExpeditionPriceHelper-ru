...
internal sealed class CalibrationOverlay : Form
{
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        g.DrawString("Обведите список предметов на панели обмена, затем ENTER — подтвердить. ESC — отмена.",
        ...
        if (_confirmedRectScreen.Width > 0)
        {
            ...
            g.DrawString("ENTER — подтвердить, перетащите заново — изменить", subFont, fg,
