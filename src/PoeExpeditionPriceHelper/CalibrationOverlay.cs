...
internal sealed class CalibrationOverlay : Form
{
    ...
    public CalibrationOverlay()
    {
        ...
        Text = "Калибровка — обведите список предметов";
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        g.DrawString("Обведите область списка предметов, затем нажмите ENTER для подтверждения. ESC — отмена.",
        ...
        if (_confirmedRectScreen.Width > 0)
        {
            ...
            g.DrawString("Нажмите ENTER для подтверждения, перетащите для переделки", subFont, fg,
